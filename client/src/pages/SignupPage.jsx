...
import {
  Code2, Eye, EyeOff, AlertCircle, CheckCircle2,
  ArrowLeft, Shield, Video, Zap, Sparkles
} from 'lucide-react';
        ...
        <div className="login-left-panel">
          ...
          <div className="login-intro">
            <span className="login-badge-tag">
              <Sparkles size={12} /> Instant Account Access
            </span>
            <h2 className="login-intro-title">
              Create Your Free Account
            </h2>
            <p className="login-intro-sub">
              Join real-time coding sessions, share your code across multi-cursor rooms, and collaborate over WebRTC video.
            </p>
          </div>
          ...
          <div className="login-feature-list">
            <div className="login-feat-item">
              ...
              <div>
                <h4 className="login-feat-name">100% Free & Open Source</h4>
                <p className="login-feat-detail">No credit cards, subscriptions, or locked rooms</p>
              </div>
            </div>
            ...
            <div className="login-feat-item">
              ...
              <div>
                <h4 className="login-feat-name">Integrated WebRTC Rooms</h4>
                <p className="login-feat-detail">Instant peer video conferencing with zero lag</p>
              </div>
            </div>
            ...
            <div className="login-feat-item">
              ...
              <div>
                <h4 className="login-feat-name">Real-Time Event Audit</h4>
                <p className="login-feat-detail">Trace code changes and team messages continuously</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="login-right-panel">
          <div className="login-form-inner">
            <div className="login-form-header">
              ...
              <p className="login-sub">Start coding and collaborating in seconds</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="login-form" noValidate>
              ...
              <button
                ...
                onClick={() => setError('Google sign-up is disabled in local mode.')}
              >
                <GoogleIcon />
                <span>Sign up with Google (Local Mode)</span>
              </button>
            </form>
